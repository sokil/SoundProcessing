...
namespace Sound.Model
{
    public class Wall
    {
        ...
        private Dictionary<Name, string> _captionList = new Dictionary<Name, string>() { 
           {Name.Room1Floor, "Підлога першої камнати"},
           {Name.Room2Floor, "Підлога другої кімнати"},
           {Name.Room1Seiling, "Стеля першої камнати"},
           {Name.Room2Seiling, "Стеля другої кімнати"},
           {Name.Room1BackWall, "Задня стіна першої камнати"},
           {Name.Room2BackWall, "Задня стіна другої кімнати"},
           {Name.Room1FrontWall, "Передня стіна першої камнати"},
           {Name.Room2FrontWall, "Передня стіна другої камнати"},
           {Name.SeparateWall, "Суміжня стіна"}
        };
        ...
        public string getWallCaption()
        {
            return _captionList[_name];
        }
